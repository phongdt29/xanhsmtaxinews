	...
	if ( ! empty( $custom_sidebars ) && is_array( $custom_sidebars ) ) {
		foreach ( $custom_sidebars as $sidebar ) {
			...
			$list_sidebar[ $sidebar_id ] = array(
				...
				'id'            => Penci_PenNews_MG_Helper::convert_sidebar_id( $sidebar ),
				'name'          => $sidebar,
				'description'   => '',
...
$post_sidebar = isset( $post_settings['td_sidebar'] ) ? Penci_PenNews_MG_Helper::convert_sidebar_id( $post_settings['td_sidebar'] ) : '';
